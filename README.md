...
|:--|--:|--:|--:|--:|
|1.|Σετ Ανοιχτών Δεδομένων |Ανοιχτά Μετεωρολογικά Δεδομένα του μετεωρολογικού σταθμού του ΠΣΠΘ | | [ΕΔΩ]|
|2.|Διάχυση | 1η Μαθητική Δράση για το Κλίμα και την Κλιματική Αλλαγή | Παρουασίαση του εκπαιδευτικού προγράμματος | [ΕΔΩ]|
