...
|7.|Φύλλο Εργασίας| Επεξεργασία δεδομένων βροχόπτωσης - Φυσική/Γεωγραφία Α Γυμνασίου | Φύλλο Εργασίας Επεξεργασία δεδομένων βροχόπτωσης για το μάθημα της Φυσικής και της Γεωργραφίας της Α Γυμνασίου  |[ΕΔΩ](https://drive.google.com/file/d/1cum40Wcm9yIJ8j6JKrNnFzena44DmIT1/view?usp=share_link) |
|7.|Φύλλο Εργασίας| Επεξεργασία δεδομένων θερμοκρασίας - Φυσική/Γεωγραφία Α Γυμνασίου| Φύλλο Εργασίας Επεξεργασία δεδομένων θερμοκρασίας για το μάθημα της Φυσικής και της Γεωργραφίας της Α Γυμνασίου  |[ΕΔΩ](https://drive.google.com/file/d/1lAlmr_PHpEOl3WEr_zeQCG-DTW-Qiihc/view?usp=sharing) |
...
|3.|Διδακτικό Σενάριο Πληροφορική Β Γυμνασίου - Ύψος Βροχόπτωσης |Μελετώντας το φαινόμενο της κλιματικής αλλαγής μέσα από την καταγραφή και ανάλυση μετεωρολογικών δεδομένων|Διδακτικό Σενάριο επεξεργασίας αυθεντικών μετεωρολογικών δεδομένων τα οποία προέρχονται από του μετεωρολογικό σταθμό του ΠΣΠΘ.|Σενάριο [ΕΔΩ](https://drive.google.com/file/d/1Al7UzjZyOVhm1UpJJqo9_qOFS4gAo_i5/view?usp=share_link) Φύλλο Εργασίας [ΕΔΩ](https://drive.google.com/file/d/1U0BocfiZFu3UFEcDdfsBfNEH17-82QPB/view?usp=share_link)|
|4.|:--|--:|--:|--:|--:|
