...
|:--|--:|--:|--:|--:|
|1.| Ανοιχτό Διδακτικό Σενάριο | Εκπαιδευτική Ρομποτική και μετεωρολογία με Raspberry Pi και Python, Φίλιππος Κουτσάκας| Ανοιχτό Διδακτικό Σενάριο κατασκευής, παραμετροποίησης και εκπαιδευτικής αξιοποίησης ενός πρότυπου μετεωρολογικού σταθμού βασιμένου σε Τεχνολογίες Ανοιχτής Αρχιτεκτονικής | Διδακτικό Σενάριο [ΕΔΩ](https://docs.google.com/document/d/1kBUMAP1vzNMj_Wyzo8d--d9JldsFegor/edit) |
|2.|	Εξοπλισμός | Μετεωρογικός Σταθμός | Μετεωρολογικός σταθμός σταθερής θέσης βασισμένος σε Τεχνολογίες Ανοιχτής Αρχιτεκτονικής (Raspberry Pi) και στην γλώσσα προγραμματισμού Python, με δυνατότητα καταγραφής σε πραγματικό χρόνο (α) θερμοκρασίας, (β) σχετικής υγρασίας, (γ) ατμοσφαιρικής πίεσης, (δ) ύψους βροχής, (ε) ταχύτητας και (στ) κατεύθυνσης ανέμου | Οδηγίες συναρμολόγησης/παραμετροποίησης [ΕΔΩ](https://docs.google.com/document/d/1kBUMAP1vzNMj_Wyzo8d--d9JldsFegor/edit)|
